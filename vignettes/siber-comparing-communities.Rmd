...
And that pretty is pretty much that for comparing these metrics across communities, except perhaps to make a probabalistic statement about how convex hull area TA (for example) differs between __Community 1__ and __Community 2__. In this case, what is the probabily that TA in Community 1 is almost the same as that in Community 2?
