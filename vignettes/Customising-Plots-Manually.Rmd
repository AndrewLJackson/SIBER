...
# Here is where we plot the raw data only into a plotting window.
# Later we will add more elements such as our custom ellipses.
# All the plotting element toggles are set to FALSE.
