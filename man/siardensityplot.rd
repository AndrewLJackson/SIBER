...
% Please edit documentation in R/siardensityplot.R
\name{siardensityplot}
\alias{siardensityplot}
\title{Plot credible intervals as shaded boxplots using \code{\link{hdr.boxplot}}}
\usage{
siardensityplot(dat, probs = c(95, 75, 50), xlab = "Group",
  ylab = "Value", xticklabels = NULL, yticklabels = NULL,
  clr = gray((9:1)/10), scl = 1, xspc = 0.5, prn = F, ct = "mode",
  ylims = NULL, lbound = -Inf, ubound = Inf, main = "", ylab.line = 2,
  ...)
}
\arguments{
...
\item{prn}{a logical value determining whether summary statisics of each column
...
\item{...}{further graphical parameters for passing to \code{\link{plot}}}
}
\value{
A new figure window.
}
